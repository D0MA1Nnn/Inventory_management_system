...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
                <p class="text-xl font-medium uppercase tracking-[0.2em] text-blue-600">Security Monitoring</p>
                <p class="mt-2 max-w-2xl text-sm text-gray-500">
                    Review successful login and logout activity across admin, manager, and staff accounts.
                </p>
            </div>

            <form method="GET" action="{{ route('admin.logs.index') }}" class="grid gap-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:grid-cols-3">
                <div>
                ...
                <div class="flex items-end gap-2">
                    <button
                        type="submit"
                        class="inline-flex flex-1 items-center justify-center rounded-xl bg-gray-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-gray-800"
                    >
                        Apply Filters
                    </button>
                    <a
                        href="{{ route('admin.logs.index') }}"
                        class="inline-flex items-center justify-center rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-semibold text-gray-600 transition hover:bg-gray-50"
                    >
                        Reset
                    </a>
                </div>
